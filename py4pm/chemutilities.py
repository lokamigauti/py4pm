...
def get_sourceColor(source=None):
    ...
    color = {
        ...
        "Brakes + Ressuspension": "#eb4034",
        "Fertilizer + Coal": "#26ab31",
        "Geogenic + Vehicular": "#edaf13",
        "Coal": "#3f454a",
        "Fertilizer": "#00a61e",
        "Geogenic": "#bd5800",
        "Vehicular + Ressuspension": "#d41313",
        'DRS2 SETOR 05 / SOLO DO DRS 2 - ÁREA FILTRO PRENSA (DRS2S05)': "#c75e0e",
        'A. EMPRÉSTIMO M. SILTOSO 04/11/21 - SOLO ÁREA DE EMPRÉSTIMO - PORÇÃO SILTOSA (AEMST)': "#995c2e",
        'A. EMPRÉSTIMO M. ORGÂNICO 04/11/21 / SOLO ÁREA DE EMPRÉSTIMO - PORÇÃO ORGÂNICA (ARBFMO)': "#6b3002",
        'DRS 1 F. TAMBOR 04/11/21 / SOLO DRS 1 - ÁREA FILTRO TAMBOR (FTFO1DRS01)': "#5c4331",
        'DRS-1 FILTRO PRENSA FAIXA 06 04/11/21 / SOLO DRS 1 - ÁREA FILTRO PRENSA (DRS-1FPFX06)': "#5c4e44",
        'BAUXITA 07/08/21 ESTOCAGEM / BAUXITA - (BAX)': "#9e1033",
        'CINZAS DRS-1 04/11/21 / CINZA DRS 1 (CINZAS DRS-1)': "#525252",
        'ALUMINA ESTOCAGEM 21/07/21 - ALUMINA (AL. EST)': "#664d53",
        'CARVÃO 07/08/21 ESTOCAGEM / CARVÃO (CARVÃO)': "#29180f",
        'Factor 1': '#0062ff',
        'Factor 2': '#c300ff',
        'Factor 3': '#ff0073',
        'Factor 4': '#ff2f00',
...
def get_sourcesCategories(profiles):
    ...
    possible_sources = {
        ...
        "Chlorure": "Chloride",
        "Brakes + Ressuspension": "Brakes + Ressuspension",
        "Fertilizer + Coal": "Fertilizer + Coal",
        "Geogenic + Vehicular": "Geogenic + Vehicular",
        "Coal": "Coal",
        "Fertilizer": "Fertilizer",
        "Geogenic": "Geogenic",
        "Vehicular + Ressuspension": "Vehicular + Ressuspension",
        "PM other": "Other",
